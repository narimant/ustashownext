...
const SignePageBlog = () => {
 ...
 <>
    <div className="bg-white rounded-lg shadow-light p-5 border-gray-700">
      ...
      <div class="flex flex-wrap items-center gap-3 mb-6 py-4">
        <div class="text-sm font-danaMedium text-zinc-700 dark:text-white flex justify-start items-center gap-1">
          <CiUser size={25} />
